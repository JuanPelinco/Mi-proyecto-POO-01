 ...
 */
package pe.edu.upeu.arraylistobjectherencia.vistacontrol;

import java.util.ArrayList;
import pe.edu.upeu.arraylistobjectherencia.modelo.Trabajador;
import pe.edu.upeu.arraylistobjectherencia.utils.Lectura;
import pe.edu.upeu.arraylistobjectherencia.utils.Utiliarios;
...
"55512155");
 ...
 Trabajador trabajador = new Trabajador(salario, area_trabajo, cargo, id, nombre,
dni);
...
trabajadores.get(posicion).getNombre());
 ...
 System.out.println("* Area de Trabajo actual: " +
trabajadores.get(posicion).getArea_trabajo());
...
trabajadores.get(posicion).getSalario());
